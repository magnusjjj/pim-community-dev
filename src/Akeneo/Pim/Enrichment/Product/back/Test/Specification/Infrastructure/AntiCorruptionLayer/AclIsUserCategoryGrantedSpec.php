...
{
    function let($productCategoryAccessQuery, UserRepositoryInterface $userRepository)
    {
    ...
    {
        $productCategoryAccessQuery->getGrantedProductIdentifiers(['foo'], 'john', AccessLevel::OWN_PRODUCTS)
